...
<div class="navbar navbar-expand-lg changeTheme navbar-static">
    ...
    <div class="navbar-brand ">
        <a href="{{ route('admin-dashboard') }}" class="d-inline-block">
            ...
            <span class="d-none d-sm-block" style="font-size: 20px; font-weight: 700;color:  rgb(150, 214, 150);">Admin Dashboard</span>
        </a>
    </div>
    ...
    <ul class="navbar-nav flex-row order-1 order-lg-2 flex-1 flex-lg-0 justify-content-end align-items-center">
        <li class="nav-item nav-item-dropdown-lg dropdown dropdown-user h-100">
            <a href="#" class="navbar-nav-link navbar-nav-link-toggler nav-link dropdown-toggle d-inline-flex align-items-center h-100" data-toggle="dropdown">
